package online.superh.haro.framework.jackson.config;
...
import online.superh.haro.framework.jackson.core.NumberSerializer;
...
@AutoConfiguration
@Slf4j
public class HaroJacksonAutoConfiguration {
